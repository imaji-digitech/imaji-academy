    ...
    public function getRules()
    {
        if ($this->action == 'create') {
            return [
                ...
                'user.class' => 'required|max:255',
                'user.hobby' => 'required|max:255',
                'user.future_goal' => 'required|max:255',
                'user.parent_name' => 'required|max:255',
                'user.parent_job' => 'required|max:255',
                'user.nis' => 'required|max:255',
                'user.birthday' => 'required|max:255',
                'user.ips' => 'required',
                'user.age' => 'required',
            ];
        } else {
